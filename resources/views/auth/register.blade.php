...
<html lang="id">
    <head>
        ...
        <title>Daftar · Mahligai Bakery</title>
    ...
    <body class="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-800 via-brand-950 to-brand-900 p-4 font-sans text-brand-950 antialiased">
        <div class="w-full max-w-sm">
            ...
            <div class="mt-6 rounded-3xl bg-white p-7 shadow-2xl">
                <h1 class="font-display text-xl font-semibold text-brand-950">Buat Akun Pelanggan</h1>
                <p class="mt-1 text-sm text-brand-950/50">Daftar untuk memesan dan melihat riwayat pesanan Anda.</p>
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="mt-6 space-y-4">
                    @csrf
                    <div>
                        <label for="name" class="text-xs font-semibold text-brand-800">Nama Lengkap</label>
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" required value="{{ old('username') }}"
                            autocomplete="username" placeholder="misal: budi_santos"
                            class="mt-1.5 w-full rounded-2xl bg-cream-100 px-4 py-3 text-sm text-brand-950 ring-1 ring-brand-950/10 transition placeholder:text-brand-950/35 focus:ring-2 focus:ring-brand-400 focus:outline-none">
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="password_confirmation" class="text-xs font-semibold text-brand-800">Ulangi Kata Sandi</label>
